...
const Hero = () => {
  return (
    <div className='h-[75vh] flex flex-col md:flex-row items-center justify-center'>
        ...
        <h1 className='text-4xl lg:text-6xl font-semibold text-yellow-100 lg text-center lg:text-left'>
            Discover Your Next Great Read
            </h1>
        <p className='mt-4 text-xl text-zinc-300 text-center lg:text-left'>
            Uncover captivating stories, enriching knowledge, and endless inspiration in our curated colection of books.
            </p>
        ...
        <img src="./hero1real.png" alt="hero" srcset="" /></div>
    </div>
  )
}
